  ...
  render() {
    ...
    return (
      <form>
        ...
        {(!this.state.name && this.state.ingredients.length === 0) ? <p className='error'>Please fill out your name and select ingredients to place an order</p> : <button onClick={e => this.handleSubmit(e)}>
          Submit Order
        </button>}
